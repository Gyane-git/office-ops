...
from main_app import manager_views 

from .ceo_views import *
...
urlpatterns = [
    ...
    path("manager/salary/add/", manager_add_salary, name='manager_add_salary'),
    path("manager/salary/edit/", EditSalaryView.as_view(), name='edit_employee_salary'),
    path("manager/salary/fetch/", fetch_employee_salary, name='fetch_employee_salary'),
    path("manager/salary/save/", save_salary, name='save_salary'),
    path("manager/salary/update-status/", update_salary_status, name='update_salary_status'),
    path("manager/salary/delete/", delete_salary, name='delete_salary'),
    path("manager/get-employees/", get_employees, name='get_employees'),
    ...
    path("employee/view/salary/", employee_view_salary, name='employee_view_salary'),
